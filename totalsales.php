...
$user=file_get_contents('common/session.dll');
...
<?php
$table=date('M_Y');
$total=$PDO->query("SELECT SUM(total_weight) as weight FROM `$table`");
...
foreach($get->fetchAll() as $row){
  $id=$row['id'];
  $sale=$row['total_weight']*20;}

?>
                          </div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo ($sale*20);?></div>
                    </div>
                    <div class="col-auto">
...
?>
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo ($sale*15);?></div>
                    </div>
                    <div class="col-auto">
                      <i class="fa fa-dollar fa-2x text-gray-300"></i>
                    </div>
...
?>
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo ($total*20);?></div>
                    </div>
                    <div class="col-auto">
                      <i class="fa fa-dollar fa-2x text-gray-300"></i>
                    </div>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="chart-area">
                    ...
                    $.ajax({
                      method:"GET",
                      url:"control.php?getmonth",
                      dataType:'json',
                      success:function(data){
                        var date=[];
                        var weight=[];
                        for(i in data){
                          date.push(data[i].date_bought);
                          weight.push(data[i].total_weight);
                        }
                    ...
                    labels: date,
                    datasets: [{
                    label:'Production in Kg(current Month)',
                    data: weight,
      backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    'rgba(54, 162, 235, 0.2)',
